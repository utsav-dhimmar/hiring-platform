                    ...
                    >
                        <defs>
                            <linearGradient id="gradientTotal" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor={colors.Total[0]} stopOpacity={0.8} />
                                <stop offset="100%" stopColor={colors.Total[1]} stopOpacity={1} />
                            </linearGradient>
                            <linearGradient id="gradientApproved" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor={colors.Approved[0]} stopOpacity={0.8} />
                                <stop offset="100%" stopColor={colors.Approved[1]} stopOpacity={1} />
                            </linearGradient>
                            <linearGradient id="gradientRejected" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor={colors.Rejected[0]} stopOpacity={0.8} />
                                <stop offset="100%" stopColor={colors.Rejected[1]} stopOpacity={1} />
                            </linearGradient>
                            <linearGradient id="gradientMaybe" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor={colors.Maybe[0]} stopOpacity={0.8} />
                                <stop offset="100%" stopColor={colors.Maybe[1]} stopOpacity={1} />
                            </linearGradient>
                            <linearGradient id="gradientPending" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="0%" stopColor={colors.Pending[0]} stopOpacity={0.8} />
                                <stop offset="100%" stopColor={colors.Pending[1]} stopOpacity={1} />
                            </linearGradient>
                        </defs>
